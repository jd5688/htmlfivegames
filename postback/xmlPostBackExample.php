...
//$xml_document = base64_decode(file_get_contents('php://input'));
...
foreach ($exports as $export) {
	...
	foreach($orders as $order) {
		...
		echo "<b>$orderId - Placed By $shipToFirstName $shipToLastName</b><br>";
		
		// Now let's get the items and print out some info about them.
		echo "<b>Items in Order</b><ul>";
		...
		foreach($items as $item) {
			...
			echo "<li>$itemId ($description) - Quantity $quantity</li>";
		}
